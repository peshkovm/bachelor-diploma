...
public class W {
    public static void main(String[] args) throws Exception {
        ...
        Files.list(Paths.get("C:\\JavaLessons\\bachelor-diploma\\Streaming\\src\\test\\resources\\streaming_files\\companies\\apple")).forEach(path -> {
            try {
        ...
        lines.forEach(a -> {
            try {
                BufferedWriter writer = Files.newBufferedWriter(Paths.get("C:\\JavaLessons\\bachelor-diploma\\Streaming\\src\\test\\resources\\streaming_files\\in_files\\apple\\" + i[0]++ + ".txt"));
                writer.write(a);
                writer.close();
