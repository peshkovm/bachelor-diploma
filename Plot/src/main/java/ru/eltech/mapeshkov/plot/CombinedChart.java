...
public class CombinedChart extends ApplicationFrame {
     ...
     */
    public CombinedChart(final String title, final String xLabel, final String yLabel, final XYSeries... series) {
     ...
     * @param series
     */
    public CombinedChart(final String title, final String xLabel, final String yLabel, final int width, final int height, final XYSeries... series) {
        super(title);
     ...
     */
    public CombinedChart(final String title, final String xLabel, final String yLabel, final Comparable<?>... keys) {
     ...
     * @param keys   array of names of plots of chart
     */
    public CombinedChart(final String title, final String xLabel, final String yLabel, final int width, final int height, final Comparable<?>... keys) {
        this(title, xLabel, yLabel, width, height, Arrays.stream(keys).map(XYSeries::new).toArray(XYSeries[]::new));
    }

    private JFreeChart createCombinedChart(final String title, final String xLabel, final String yLabel, final java.util.List<XYSeries> seriesList) {
