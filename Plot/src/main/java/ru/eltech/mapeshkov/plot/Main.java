...
public class Main {
    public static void main(String[] args) throws Exception {
        final String dirName = "C:\\JavaLessons\\bachelor-diploma\\Streaming\\src\\test\\resources\\streaming_files\\prediction";
    ...
    static void fooDenis() throws Exception {
        String fileName = "C:\\JavaLessons\\bachelor-diploma\\Streaming\\src\\test\\resources\\streaming_files\\prediction\\predict.txt";
        final PlotHelper plotHelper = new PlotHelper(fileName);
        //final Watcher watcher = new Watcher(Paths.get("C:\\JavaLessons\\bachelor-diploma\\Streaming\\src\\test\\resources\\streaming_files\\prediction\\"));
